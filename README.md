  ...
  <style>
    ...
    * {
    ...
    .brand h1 {
      font-size: 2rem;
      color: var(--text-color);
      /* Underline effect to match your mobile header design */
    ...
    /* Decorative Images (Desktop Layout) */
    .design-image {
      position: absolute;
      opacity: 0.9;
      border-radius: 8px;
    ...
    @media (max-width: 768px) {
      /* Keep header in a row with brand on left, nav on right */
      header .container {
        flex-direction: row;
        justify-content: space-between;
      }
      ...
      /* Reposition decorative images away from hero content */
      .design-image {
        width: 60px;
      }
      ...
      /* Hide extra images for clarity on smaller screens */
      .design-image.img5,
