  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      line-height: 1.6;
      /* Add top padding to prevent content from being hidden behind the header when visible */
      padding-top: 80px;
    }
    ...
    /* Decorative Images - Arrangement for larger screens */
    .design-image {
      position: absolute;
      opacity: 0.9;
      border-radius: 8px;
    ...
    /* Additional responsive improvements for smaller phones */
    @media (max-width: 480px) {
      .design-image.img1 { top: 40%; left: 3%; width: 50px; }
      .design-image.img2 { top: 40%; right: 3%; width: 50px; }
      .design-image.img3 { bottom: 5%; left: 5%; width: 50px; }
      .design-image.img4 { bottom: 5%; right: 5%; width: 50px; }
      .design-image.img5 { top: 55%; left: 0%; width: 50px; }
      .design-image.img6 { bottom: 10%; right: 0%; width: 50px; }
...
<body>
  ...
  <section id="home" class="hero">
    <div class="hero-content">
      <!-- Full Logo displayed in the hero -->
  ...
  <!-- Footer (non-fixed, original style) -->
  <footer>
