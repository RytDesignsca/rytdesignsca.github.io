...
<body>
  ...
  <div id="checkoutModal" class="modal">
    <div class="modal-content">
      ...
      <div style="color: red; font-weight: bold; margin-bottom: 12px;">
        This checkout is for demonstration only. Do not enter real payment details.
      </div>
    ...
    <div id="homeContent">
      ...
      <section id="contact">
        ...
        <div class="contact-container">
          <!-- Single project inquiry form using Formspree -->
          <form id="projectInquiryForm" class="project-inquiry-form" autocomplete="off" method="POST" action="https://formspree.io/f/mjkrwwpk">
            ...
            <textarea id="vision" name="vision" required placeholder="e.g. I want a bold, clean logo for my bakery, maybe with pastel colors..."></textarea>
            <label for="requirements">Key requirements or inspirations?</label>
            <textarea id="requirements" name="requirements" placeholder="Logo shapes, colors, examples, must-have ideas, etc."></textarea>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    // -- Project Inquiry Form logic (Formspree) --
    const form = document.getElementById('projectInquiryForm');
    const formSuccess = document.getElementById('formSuccess');
    const formError = document.getElementById('formError');
    if (form) {
      form.addEventListener('submit', function(e){
        // Let the browser/Formspree handle submission, just show feedback after a short delay
        setTimeout(() => {
          formSuccess.style.display = "block";
          formSuccess.textContent = "Thank you! Your inquiry has been sent.";
