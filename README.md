...
<body>
  ...
  <section id="products">
    ...
    <div class="portfolio-container">
      ...
      <div class="portfolio-item">
        <embed src="ryt designs presentation.pdf" type="application/pdf" width="100%" height="400px">
        <h3>RYT DESIGNS PRESENTATION</h3>
      </div>
      <!-- Product 3: Itinerary -->
      <div class="portfolio-item">
        <img src="A A itinerary.png" alt="Itinerary">
        <h3>Itinerary</h3>
      </div>
      <!-- Product 4: Banner -->
      <div class="portfolio-item">
        <img src="Banner 4 website.png" alt="Banner">
        <h3>Banner</h3>
      </div>
      <!-- Product 5: Bussiness Card -->
      <div class="portfolio-item">
        <img src="business card proto.jpg" alt="Bussiness Card">
        <h3>Bussiness Card</h3>
      </div>
      <!-- Product 6: Birtday Card -->
      <div class="portfolio-item">
        <img src="celeb 4 website.png" alt="Birtday Card">
        <h3>Birtday Card</h3>
      </div>
      <!-- Product 7: Invitation -->
      <div class="portfolio-item">
        <img src="invitation 4 website.png" alt="Invitation">
        <h3>Invitation</h3>
      </div>
      <!-- Product 8: Logo -->
      <div class="portfolio-item">
        <img src="Logo 4 website.png" alt="Logo">
        <h3>Logo</h3>
      </div>
      <!-- Product 9: Menu -->
      <div class="portfolio-item">
        <img src="Menu 4 website.png" alt="Menu">
        <h3>Menu</h3>
      </div>
      <!-- Product 10: youtube Thumbnail -->
      <div class="portfolio-item">
        <img src="youtube thumbnail 4 website.png" alt="youtube Thumbnail">
        <h3>youtube Thumbnail</h3>
      </div>
      <!-- Product 11: Website Prototype -->
      <div class="portfolio-item">
        <img src="website prototype no hyphens.png" alt="Website Prototype">
